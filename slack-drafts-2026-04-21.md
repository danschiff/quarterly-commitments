...
DM `<@U0EG2DG5U>`, `<@TODO_CORY_SLACK_ID>`, and `<@U0ADRG6EZ37>`

```
Hi <@U0EG2DG5U>, <@TODO_CORY_SLACK_ID>, and <@U0ADRG6EZ37>,

Doing my weekly check-in on quarterly commitments for the *Recruiting* team (22% through the quarter).
...
Doing my weekly check-in on quarterly commitments for the *Learning Management* team (22% through the quarter).
...
Doing my weekly check-in on quarterly commitments for the *Performance Management* team (22% through the quarter).
...
Doing my weekly check-in on quarterly commitments for the *Compensation Management* team (22% through the quarter).
